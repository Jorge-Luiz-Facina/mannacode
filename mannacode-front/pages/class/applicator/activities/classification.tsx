...
import { getPunctuationPlayersFinalizedActivitieApplicator } from '@/services/challengePlayersFinalized';
...
function Classification(props) {
  ...
  useEffect(() => {
    ...
    if (page && signed) {
      setLoading(true);
      getPunctuationPlayersFinalizedActivitieApplicator({ ...page, groupChallengeId }, token)
        .then((response) => {
